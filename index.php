...
<body>
    ...
    <div class="h-screen md:flex">
        <div class="flex md:w-1/2 justify-around py-10 items-center bg-white">
            <form class="bg-white" method="post" action="ceklogin.php">
                ...
                <div class="flex  border-2 py-2 px-3 rounded mb-5">
                    <input class="pl-2 outline-none border-none" type="text" name="" id="username" placeholder="username" />
                </div>
                <div class="flex items-center border-2 py-2 px-3 rounded mb-5">
                    <input class="pl-2 flex w-[300px] outline-none border-none" type="password" name="password" id="" placeholder="Password" />
