                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7 mx-auto pt-3">
                            <div class="card shadow mb-4" style="padding-bottom: 20%;">
                                ...
                                <form class="px-5 py-4" method="post" action="./mysql/tambahkategori.php">
                                    <div class="form-group " style="padding-top: 5%;">
                                        <label for="exampleDropdownFormEmail1">Category Name</label>
                                        <input type="text" name="CatNames" class="form-control" id="exampleDropdownFormEmail1" placeholder="Category Name">
                                    </div>
